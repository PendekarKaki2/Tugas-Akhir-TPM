                ...
                children: [
                  ...
                  _FeatureCard(
                    ...
                    onTap: () {
                      ...
                      if (role == 'mentor') {
                        Navigator.pushNamed(context, AppNavigation.mentorUpload);
                      } else {
                        Navigator.pushNamed(context, AppNavigation.studentMaterials);
                      }
                    },
                  ),
                  // Image Guessing
                  ...
                  // Mentor-only quick create quiz
                  if (authProvider.currentUser?.role == 'mentor')
                    _FeatureCard(
                      icon: Icons.create,
                      title: 'Buat Quiz',
                      color: Colors.indigo,
                      onTap: () => Navigator.pushNamed(context, AppNavigation.mentorCreateQuiz),
                    ),
                  // Chatbot
                  _FeatureCard(
                    icon: Icons.chat,
