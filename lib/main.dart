  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => MentorProvider(materialRepository, quizRepository),
        ),
        ChangeNotifierProvider(
          create: (_) => StudentProvider(materialRepository, quizRepository),
        ),
        ChangeNotifierProvider(
        ...
        builder: (context, themeProvider, _) {
          return MaterialApp(
            ...
            routes: {
              ...
              AppNavigation.mentorUpload: (context) => const MentorUploadScreen(),
              AppNavigation.mentorCreateQuiz: (context) => const MentorCreateQuizScreen(),
              AppNavigation.studentMaterials: (context) => const StudentMaterialsScreen(),
              AppNavigation.studentTakeQuiz: (context) {
                final args = ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>?;
                final quizId = args != null && args['quizId'] != null ? args['quizId'] as int : 0;
